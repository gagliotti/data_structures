...
\usepackage{listings}
\usepackage{tikz}
\usetikzlibrary{calc,chains,arrows, positioning, positioning,topaths, shapes, bending}
\usepackage{multirow}
\usepackage{amsfonts}
\usepackage{amssymb}
...
\lstset{language=C++,
  ...
  node_nil/.style = {treenode, rectangle, draw=black,
    minimum width=0.5em, minimum height=0.5em}
          ...
          \begin{itemize}
          \item O nodo com chave \textcolor{red}{6.5} desequilibrou a árvore no nodo \textcolor{blue}{8}. Com a \textcolor{magenta}{rotação} da subárvore em torno do nodo 7 (\textcolor{magenta}{rotação simples à esquerda}), rebalanceamos.
          \end{itemize}
\begin{columns}
\column{.45\textwidth}
...
\node [node_s] {6}
   ...
   child{ node (8)[node_g, color=blue] {8}
	   child{ node (7) [node_s] {7} 
    	   child{ node [node_s, color=red] {6.5}} 
    	   child[missing]{ node [node_nil] {}}
	   } 
	   child[missing]{ node [node_nil] {}}  
   }
; 
%\draw [->, bend left=45, magenta, thick] (7.west) to (7.south east);
\draw[-latex,magenta, thick] (7.north)+(-10pt,2pt) arc (135:-45:.6);
\end{tikzpicture}
\column{.1\textwidth}
...
\node [node_s] {6}
   ...
   child{ node (7) [node_s] {7}
	   child{ node [node_s,color=red] {6.5} } 
	   child{ node (8) [node_s,color=blue] {8}}  
   }
; 
\end{tikzpicture}
\end{columns}         
...
\item Se chegamos à raiz sem encontrar algo errado, terminamos;
\item Saso encontremos um nodo desbalanceado  \textbf{(|altesq - altdir| > 1)}, realizamos a rotação no primeiro nodo desbalanceado encontrado;
...
\lstset{language=C++,
  ...
  node_nil/.style = {treenode, rectangle, draw=black,
    minimum width=0.5em, minimum height=0.5em}
		  ...
		  \item Executamos uma \textcolor{magenta}{rotação} simples entre a raiz (cuja condição-AVL está violada) e seu filho da direita (\textcolor{magenta}{rotação simples à direita}.)
          \end{itemize}
\begin{columns}
\column{.45\textwidth}
\begin{center}
...
\node [node_s] {1}
   child[missing]{ node [node_s] {}}
   child{ node (2) [node_s] {2}
    child[missing]{ node [node_s] {}}
    child{ node [node_g] {3}}
   }
; 
\draw[-latex,magenta, thick] (2.south)+(11pt,-3pt) arc (-45:150:.6);
\end{tikzpicture}
\end{center}
\column{.1\textwidth}
{\color{red} $\rightarrow$}
...
\node [node_s] {2}
   child {node [node_s] {1}}
   child {node [node_g,blue] {3}
    child [missing]{node [node_s] {}}
    child {node (4) [node_s] {4}
     child [missing]{node [node_s] {}}
     child {node [node_s] {5}}
    }
   }
...
\draw[-latex,magenta, thick] (4.south)+(10pt,-2pt) arc (-45:135:.6);
\end{tikzpicture}
\end{center}
\column{.1\textwidth}
{\color{red} $\rightarrow$}
...
\lstset{language=C++,
  ...
  node_nil/.style = {treenode, rectangle, draw=black,
    minimum width=0.5em, minimum height=0.5em}
          ...
          \end{itemize}
		  \item Rotacionamos na raiz entre 2 e 4 (\textcolor{magenta}{rotação simples à direita}.)
          \end{itemize}
\begin{columns}
\column{.45\textwidth}
\begin{center}
...
\lstset{language=C++,
  ...
  node_nil/.style = {treenode, rectangle, draw=black,
    minimum width=0.5em, minimum height=0.5em}
          ...
          \item Rotacionamos em 6 (\textcolor{magenta}{rotação simples à direita}).
          \end{itemize}
          \end{itemize}
\begin{columns}
\column{.45\textwidth}
...
\node [node_s] {4}
   ...
   child {node [node_g,blue] {5}
    child [missing] {node [node_s] {}}
    child {node (6) [node_s] {6}
     child [missing] {node [node_s] {}}
     child {node [node_s] {7}}    
    }
   }
...
; 
\draw[-latex,magenta, thick] (6.south)+(10pt,-2pt) arc (-45:135:.6);
\end{tikzpicture}
\end{center}
\column{.1\textwidth}
{\color{red} $\rightarrow$}
