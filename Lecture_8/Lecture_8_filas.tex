...
\begin{frame}[fragile]{Método \textit{enqueue}}
\setbeamercovered{invisible}
\begin{center}
\begin{tikzpicture}[list/.style={rectangle split, rectangle split parts=2,
    draw=green!60, fill=green!5, rectangle split horizontal}, 
...
\begin{frame}[fragile]{Método \textit{enqueue} - Caso Especial Fila Vazia}
\setbeamercovered{invisible}
\begin{center}
\begin{tikzpicture}[list/.style={rectangle split, rectangle split parts=2,
    draw=green!60, fill=green!5, rectangle split horizontal}, 
...
\begin{frame}[fragile]{Método \textit{dequeue()}}
\setbeamercovered{invisible}
\begin{center}
\begin{tikzpicture}[list/.style={rectangle split, rectangle split parts=2,
    draw=green!60, fill=green!5, rectangle split horizontal}, 
...
\begin{frame}[fragile]{Método \textit{dequeue()} - Caso Especial Fila Unitária}
\setbeamercovered{invisible}
\begin{center}
\begin{tikzpicture}[list/.style={rectangle split, rectangle split parts=2,
    draw=green!60, fill=green!5, rectangle split horizontal}, 
...
%
%
% COMENTEI TUDO O QUE VEM A SEGUIR
%
%
%
